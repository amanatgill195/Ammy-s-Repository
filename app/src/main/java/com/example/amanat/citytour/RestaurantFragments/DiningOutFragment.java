...
import com.example.amanat.citytour.RestaurantAdapters.DiningOutFragmentAdapter;
...
public class DiningOutFragment extends Fragment {
    ...
    private DiningOutFragmentAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setProgressDialog();
        View v = inflater.inflate(R.layout.fragment_dining_out, container, false);
        restaurantModelArrayList = new ArrayList<>();
        recyclerView = v.findViewById(R.id.dining_out_recycler_view);
    ...
    public void loadDataFirestore() {
        if (isNetworkAvailable()) {
            ...
            db.collection("diningOutRestaurants")
                    .get()
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            ...
                            adapter = new DiningOutFragmentAdapter(restaurantModelArrayList, DiningOutFragment.this);
